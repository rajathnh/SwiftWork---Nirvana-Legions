...
async function displayFreelancerData(freelancer) {
  ...
  <div class="mx-auto p-6">
      <div class="flex flex-col lg:flex-row lg:space-x-8">
          ...
          <img src="${freelancer.profilePic || 'default-profile.png'}" 
             ...
             <div class="w-full">
                  ...
                  <div class="verified-skills mt-4 w-full place-content-center bg-[#464477] p-4 rounded-lg flex flex-col items-center">
    ...
    <!-- Centering the Add Skills Button -->
    <div class="flex justify-center mt-4 w-full">
        <button id="addSkillsBtn" class="bg-green-500 h-10 w-42 text-white text-sm py-1 px-3 rounded-lg hover:bg-green-600 transition-colors duration-300">
            Add Skills
        </button>
    </div>
</div>
